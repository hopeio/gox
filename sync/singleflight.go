...
// mechanism.
package sync // import "golang.org/x/sync/singleflight"
...
// newPanicError creates and returns a new instance.
...
func (g *Group) doCall(c *call, key any, fn func() (any, error)) {
	normalReturn := false
	recovered := false
