...
func TestCache(t *testing.T) {
	tc := newSimpleCache(New(0))

	a, err := tc.Get("a")
	if err == nil || a != nil {
		t.Error("Getting A err value that shouldn't exist:", a)
	}

	b, err := tc.Get("b")
	if err == nil || b != nil {
		t.Error("Getting B err value that shouldn't exist:", b)
	}

	c, err := tc.Get("c")
	if err == nil || c != nil {
		t.Error("Getting C err value that shouldn't exist:", c)
	}
	...
	x, err := tc.Get("a")
	if err != nil {
		t.Error("a was not err while getting a2")
	}
	if x == nil {
	...
	x, err = tc.Get("b")
	if err != nil {
		t.Error("b was not err while getting b2")
	}
	if x == nil {
	...
	x, err = tc.Get("c")
	if err != nil {
		t.Error("c was not err while getting c2")
	}
	if x == nil {
...
func TestCacheTimes(t *testing.T) {
	...
	tc := newSimpleCache(New(0).Expiration(20 * time.Millisecond).Janitor(10 * time.Millisecond))
	tc.Set("a", 1, DefaultExpiration)
...
func TestStorePointerToStruct(t *testing.T) {
	...
	x, err := tc.Get("foo")
	if err != nil {
		t.Fatal("*TestStruct was not err for foo")
	}
	foo := x.(*TestStruct)
	foo.Num++
	...
	y, err := tc.Get("foo")
	if err != nil {
		t.Fatal("*TestStruct was not err for foo (second time)")
	}
	bar := y.(*TestStruct)
	if bar.Num != 2 {
...
func TestIncrementWithUintptr(t *testing.T) {
	...
	x, err := tc.Get("tuintptr")
	if err != nil {
		t.Error("tuintptr was not err")
	}
	if x.(uintptr) != 3 {
...
func TestIncrementWithUint16(t *testing.T) {
	...
	x, err := tc.Get("tuint16")
	if err != nil {
		t.Error("tuint16 was not err")
	}
	if x.(uint16) != 3 {
...
func TestIncrementWithUint32(t *testing.T) {
	...
	x, err := tc.Get("tuint32")
	if err != nil {
		t.Error("tuint32 was not err")
	}
	if x.(uint32) != 3 {
...
func TestIncrementWithUint64(t *testing.T) {
	...
	x, err := tc.Get("tuint64")
	if err != nil {
		t.Error("tuint64 was not err")
	}
	if x.(uint64) != 3 {
...
func TestIncrementWithFloat32(t *testing.T) {
	...
	x, err := tc.Get("float32")
	if err != nil {
		t.Error("float32 was not err")
	}
	if x.(float32) != 3.5 {
...
func TestIncrementWithFloat64(t *testing.T) {
	...
	x, err := tc.Get("float64")
	if err != nil {
		t.Error("float64 was not err")
	}
	if x.(float64) != 3.5 {
...
func TestDecrementWithUintptr(t *testing.T) {
	...
	x, err := tc.Get("uintptr")
	if err != nil {
		t.Error("uintptr was not err")
	}
	if x.(uintptr) != 3 {
...
func TestRemove(t *testing.T) {
	...
	x, err := tc.Get("foo")
	if err == nil {
		t.Error("foo was err, but it should have been deleted")
	}
	if x != nil {
...
func TestFlush(t *testing.T) {
	...
	x, err = tc.Get("baz")
	if err == nil {
		t.Error("baz was err, but it should have been deleted")
	}
	if x != nil {
		t.Error("x is not nil:", x)
	}
...
func TestOnEvicted(t *testing.T) {
	...
	if tc.evictedFunc != nil {
		t.Fatal("tc.onEvicted is not nil")
	}
	works := false
	tc.OnEvicted(func(k any, v interface{}) {
		if k == "foo" && v.(int) == 3 {
			works = true
		}
...
func testFillAndSerialize(t *testing.T, tc *Simple) {
	...
	err := tc.Save(fp)
	if err != nil {
		t.Fatal("Couldn't save lockcache to fp:", err)
	}

	oc := newSimpleCache(New(0))
	err = oc.Load(fp)
	if err != nil {
		t.Fatal("Couldn't load lockcache from fp:", err)
	}

	a, err := oc.Get("a")
	if err != nil {
		t.Error("a was not err")
	}
	if a.(string) != "a" {
		t.Error("a is not a")
	}
	...
	_, err = oc.Get("expired")
	if err == nil {
		t.Error("expired was err")
	}

	s1, err := oc.Get("*struct")
	if err != nil {
		t.Error("*struct was not err")
	}
	if s1.(*TestStruct).Num != 1 {
		t.Error("*struct.Num is not 1")
	}

	s2, err := oc.Get("[]struct")
	if err != nil {
		t.Error("[]struct was not err")
	}
	s2r := s2.([]TestStruct)
	...
	s4, err := oc.get("structception", true)
	if err != nil {
		t.Error("structception was not err")
	}
	s4r := s4.(*TestStruct)
...
func TestFileSerialization(t *testing.T) {
	...
	f, err := ioutil.TempFile("", "go-lockcache-lockcache.dat")
	if err != nil {
		t.Fatal("Couldn't create lockcache file:", err)
	}
	fname := f.Name()
	f.Close()
	tc.SaveFile(fname)
...
func benchmarkCacheGetManyConcurrent(b *testing.B, exp time.Duration) {
	...
	b.StopTimer()
	n := 10000
	tc := newSimpleCache(New(0).Expiration(exp))
	keys := make([]string, n)
	for i := 0; i < n; i++ {
...
func BenchmarkRWMutexMapSetRemove(b *testing.B) {
	b.StopTimer()
	m := map[string]string{}
	mu := sync.RWMutex{}
	b.StartTimer()
...
func BenchmarkCacheSetRemoveSingleLock(b *testing.B) {
	b.StopTimer()
	tc := newSimpleCache(New(0))
	b.StartTimer()
	for i := 0; i < b.N; i++ {
...
func BenchmarkRWMutexMapSetRemoveSingleLock(b *testing.B) {
	b.StopTimer()
	m := map[string]string{}
	mu := sync.RWMutex{}
	b.StartTimer()
...
func BenchmarkPurgeLoop(b *testing.B) {
	b.StopTimer()
	tc := newSimpleCache(New(0).Expiration(5 * time.Minute))
	tc.mu.Lock()
	for i := 0; i < 100000; i++ {
...
func TestGetWithExpiration(t *testing.T) {
	...
	a, expiration, err := tc.GetWithExpiration("a")
	if err == nil || a != nil || !expiration.IsZero() {
		t.Error("Getting A err value that shouldn't exist:", a)
	}

	b, expiration, err := tc.GetWithExpiration("b")
	if err == nil || b != nil || !expiration.IsZero() {
		t.Error("Getting B err value that shouldn't exist:", b)
	}

	c, expiration, err := tc.GetWithExpiration("c")
	if err == nil || c != nil || !expiration.IsZero() {
		t.Error("Getting C err value that shouldn't exist:", c)
	}
	...
	x, expiration, err := tc.GetWithExpiration("a")
	if err != nil {
		t.Error("a was not err while getting a2")
	}
	if x == nil {
	...
	x, expiration, err = tc.GetWithExpiration("b")
	if err != nil {
		t.Error("b was not err while getting b2")
	}
	if x == nil {
	...
	x, expiration, err = tc.GetWithExpiration("c")
	if err != nil {
		t.Error("c was not err while getting c2")
	}
	if x == nil {
	...
	x, expiration, err = tc.GetWithExpiration("d")
	if err != nil {
		t.Error("d was not err while getting d2")
	}
	if x == nil {
	...
	x, expiration, err = tc.GetWithExpiration("e")
	if err != nil {
		t.Error("e was not err while getting e2")
	}
	if x == nil {
	...
	if expiration.UnixNano() != tc.items["e"].expiration.UnixNano() {
