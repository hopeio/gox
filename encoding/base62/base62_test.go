...
// TestEncodeBase62 tests the EncodeToString function with various inputs
func TestEncodeBase62(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			result := EncodeToString(tt.input)
...
// This assumes there's a corresponding DecodeString function
func TestEncodeBase62Consistency(t *testing.T) {
	...
	for _, testCase := range testCases {
		encoded := EncodeToString(testCase)
