...
var supportedTypes = map[string]struct{}{"int64_t": {}, "long": {}}
...
func NewTranslateUnit(source string, outputDir string, options ...string) TranslateUnit {
	...
	return TranslateUnit{
		Source:     source,
		Assembly:   noExtSourcePath + ".asm",
		Object:     noExtSourcePath + ".o",
		GoAssembly: noExtSourcePath + ".s",
		Go:         noExtSourcePath + ".go",
...
func (t *TranslateUnit) parseSource() ([]Function, error) {
	...
	ast, err := cc.Parse(&cc.Config{}, []string{`D:\sdk\msys64\clang64\include`}, includePaths,
...
func listIncludePaths() ([]string, error) {
	out, err := runCommand("zsh", "-c", "echo | gcc -xc -E -v -")
	if err != nil {
		return nil, err
	}
	var start bool
...
func (t *TranslateUnit) convertFunctionParameters(params *cc.ParameterList) ([]string, error) {
	...
	if _, support := supportedTypes[paramType.String()]; !support && !isPointer {
